...
{
  NS_WARNING("Attempt to set screen rotation through nsIScreen::SetRotation().  Nothing should know or care this in sandboxed contexts.  If you want *orientation*, use hal.");
  return NS_ERROR_NOT_AVAILABLE;
}
