...
MOZ_EXPORT __attribute__ ((weak)) int hybris_gralloc_lock(buffer_handle_t handle, int usage, int l, int t, int w, int h, void **vaddr);
MOZ_EXPORT __attribute__ ((weak)) int hybris_gralloc_unlock(buffer_handle_t handle);
