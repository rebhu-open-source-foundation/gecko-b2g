...
#ifndef nsNativeBasicThemeGonk_h
#define nsNativeBasicThemeGonk_h

#include "nsITheme.h"
#include "nsNativeTheme.h"

class nsNativeBasicThemeGonk : private nsNativeTheme, public nsITheme {
 public:
  nsNativeBasicThemeGonk() = default;
 ...
 protected:
  virtual ~nsNativeBasicThemeGonk() = default;
};
