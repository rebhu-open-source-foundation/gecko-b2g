...
size_t GonkBufferItem::getPodSize() const {
  size_t c = sizeof(mCrop) + sizeof(mTransform) + sizeof(mScalingMode) +
             ...
             sizeof(mFrameNumber) + sizeof(mSlot) + sizeof(mIsDroppable) +
...
status_t GonkBufferItem::flatten(void*& buffer, size_t& size, int*& fds,
                                 size_t& count) const {
...
status_t GonkBufferItem::unflatten(void const*& buffer, size_t& size,
