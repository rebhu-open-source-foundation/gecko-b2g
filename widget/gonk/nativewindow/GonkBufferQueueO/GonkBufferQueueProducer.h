...
public:
    ...
    virtual status_t attachBuffer(int* outSlot, const sp<GraphicBuffer>& buffer) override;
    ...
    virtual status_t queueBuffer(int slot,
            const QueueBufferInput& input, QueueBufferOutput* output) override;
    ...
    virtual status_t cancelBuffer(int slot, const sp<Fence>& fence) override;

    // Query native window attributes.  The "what" values are enumerated in
    // window.h (e.g. NATIVE_WINDOW_FORMAT).
    virtual int query(int what, int* outValue) override;
    ...
    virtual status_t connect(const sp<IProducerListener>& listener,
            int api, bool producerControlledByApp, QueueBufferOutput* output) override;
    ...
    virtual status_t disconnect(int api, DisconnectMode mode = DisconnectMode::Api) override;
    ...
    // handle if any.
    virtual status_t setSidebandStream(const sp<NativeHandle>& stream) override;
