...
// and the buffer pool.
class GonkConsumerBase : public virtual RefBase, protected ConsumerListener {
 public:
 ...
 protected:
  ...
  // The controlledByApp flag indicates that this consumer is under the
  // application's control.
  explicit GonkConsumerBase(const sp<IGonkGraphicBufferConsumer>& consumer,
  ...
  // The GonkConsumerBase version of onSidebandStreamChanged does nothing and
  ...
  // the derived class's implementation must call
  ...
  virtual status_t acquireBufferLocked(
      IGonkGraphicBufferConsumer::BufferItem* item, nsecs_t presentWhen);
  ...
  // The GonkConsumerBase has-a GonkBufferQueue and is responsible for creating
  // this object if none is supplied
