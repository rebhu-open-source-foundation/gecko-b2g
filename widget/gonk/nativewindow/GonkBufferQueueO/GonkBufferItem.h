...
class GonkBufferItem : public Flattenable<GonkBufferItem> {
 ...
 public:
  // The default value of mBuf, used to indicate this doesn't correspond to a
  // slot.
  ...
  // Indicates this buffer must be transformed by the inverse transform of the
  // screen it is displayed onto. This is applied after mTransform.
