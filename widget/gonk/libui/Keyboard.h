...
class KeyMap {
 public:
  ...
  inline bool haveKeyLayout() const { return !keyLayoutFile.isEmpty(); }
 ...
 private:
  bool probeKeyMap(const InputDeviceIdentifier& deviceIdentifier,
                   const String8& name);
  status_t loadKeyLayout(const InputDeviceIdentifier& deviceIdentifier,
                         const String8& name);
 ...
 */
extern bool isEligibleBuiltInKeyboard(
 ...
 */
extern int32_t updateMetaState(int32_t keyCode, bool down,
