...
void NotifyConfigurationChangedArgs::notify(
    const sp<InputListenerInterface>& listener) const {
  listener->notifyConfigurationChanged(this);
}

// --- NotifyKeyArgs ---

NotifyKeyArgs::NotifyKeyArgs(nsecs_t eventTime, int32_t deviceId,
...
NotifyDeviceResetArgs::NotifyDeviceResetArgs(nsecs_t eventTime,
                                             int32_t deviceId)
...
void NotifyDeviceResetArgs::notify(
    const sp<InputListenerInterface>& listener) const {
...
QueuedInputListener::QueuedInputListener(
    const sp<InputListenerInterface>& innerListener)
