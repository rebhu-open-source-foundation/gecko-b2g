...
#      define ALOGV_IF(cond, ...)                                            \
        ((CONDITION(cond)) ? ((void)ALOG(LOG_VERBOSE, LOG_TAG, __VA_ARGS__)) \
                           : (void)0)
#    endif
#  endif
...
#    define ALOGD_IF(cond, ...)                                          \
      ((CONDITION(cond)) ? ((void)ALOG(LOG_DEBUG, LOG_TAG, __VA_ARGS__)) \
                         : (void)0)
#  endif
...
#    define ALOGI_IF(cond, ...)                                         \
      ((CONDITION(cond)) ? ((void)ALOG(LOG_INFO, LOG_TAG, __VA_ARGS__)) \
                         : (void)0)
#  endif
...
#    define ALOGW_IF(cond, ...)                                         \
      ((CONDITION(cond)) ? ((void)ALOG(LOG_WARN, LOG_TAG, __VA_ARGS__)) \
                         : (void)0)
#  endif
...
#    define ALOGE_IF(cond, ...)                                          \
      ((CONDITION(cond)) ? ((void)ALOG(LOG_ERROR, LOG_TAG, __VA_ARGS__)) \
                         : (void)0)
#  endif
...
#      define SLOGV_IF(cond, ...)                                             \
        ((CONDITION(cond))                                                    \
             ? ((void)__android_log_buf_print(                                \
                   LOG_ID_SYSTEM, ANDROID_LOG_VERBOSE, LOG_TAG, __VA_ARGS__)) \
             : (void)0)
#    endif
#  endif
...
#      define RLOGV_IF(cond, ...)                                            \
        ((CONDITION(cond))                                                   \
             ? ((void)__android_log_buf_print(                               \
                   LOG_ID_RADIO, ANDROID_LOG_VERBOSE, LOG_TAG, __VA_ARGS__)) \
             : (void)0)
#    endif
#  endif
