...
struct InputWindowInfo {
   ...
   * overlay other windows for the purpose of implementing the secure views
   * feature. Trusted overlays, such as IME windows, can partly obscure other
   * windows without causing motion events to be delivered to them with
 ...
 *
 * Used by the native input dispatcher to indirectly refer to the window manager
 * objects that describe a window.
 */
