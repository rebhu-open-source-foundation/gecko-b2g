...
#include "nsNativeBasicThemeGonk.h"
...
/*bool
nsNativeBasicThemeGonk::CreateWebRenderCommandsForWidget(mozilla::wr::DisplayListBuilder&
...
LayoutDeviceIntMargin nsNativeBasicThemeGonk::GetWidgetBorder(
...
nsITheme::Transparency nsNativeBasicThemeGonk::GetWidgetTransparency(
...
NS_IMETHODIMP
nsNativeBasicThemeGonk::ThemeChanged() { return NS_OK; }

bool nsNativeBasicThemeGonk::WidgetAppearanceDependsOnWindowFocus(
    StyleAppearance) {
  return false;
}
...
bool nsNativeBasicThemeGonk::WidgetIsContainer(StyleAppearance aAppearance) {
  switch (aAppearance) {
    case StyleAppearance::MozMenulistArrowButton:
    case StyleAppearance::Radio:
    case StyleAppearance::Checkbox:
...
bool nsNativeBasicThemeGonk::ThemeDrawsFocusForWidget(
    StyleAppearance aAppearance) {
  switch (aAppearance) {
    case StyleAppearance::Range:
...
bool nsNativeBasicThemeGonk::ThemeNeedsComboboxDropmarker() { return true; }

already_AddRefed<nsITheme> do_GetBasicNativeThemeDoNotUseDirectly() {
  static StaticRefPtr<nsITheme> gInstance;
  if (MOZ_UNLIKELY(!gInstance)) {
    gInstance = new nsNativeBasicThemeGonk();
