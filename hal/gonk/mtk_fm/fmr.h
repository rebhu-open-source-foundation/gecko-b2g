...
struct fm_cbk_tbl {
  ...
  int (*active_af)(int fd, RDSData_Struct* rds, int band, uint16_t cur_freq,
                   uint16_t* ret_freq);
  int (*active_ta)(int fd, RDSData_Struct* rds, int band, uint16_t cur_freq,
...
enum fmr_rds_onoff { FMR_RDS_ON, FMR_RDS_OFF, FMR_MAX };

typedef enum { FM_LONG_ANA = 0, FM_SHORT_ANA } fm_antenna_type;
...
int COM_active_ta(int fd, RDSData_Struct* rds, int band, uint16_t cur_freq,
                  uint16_t* backup_freq, uint16_t* ret_freq);
int COM_deactive_ta(int fd, RDSData_Struct* rds, int band, uint16_t cur_freq,
                    uint16_t* backup_freq, uint16_t* ret_freq);
