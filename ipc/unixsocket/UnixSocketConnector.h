 ...
 * can vary between protocols (Unix sockets, TCP sockets, Bluetooth sockets,
 * etc), this allows the user to create whatever connection mechanism they need
 * while still depending on libevent for non-blocking communication handling.
 */
class UnixSocketConnector {
 public:
   ...
   * @return NS_OK on success, or an XPCOM error code otherwise.
   */
  virtual nsresult AcceptStreamSocket(int aListenFd, struct sockaddr* aAddress,
