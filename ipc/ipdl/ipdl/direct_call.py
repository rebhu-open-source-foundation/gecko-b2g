...
DIRECT_CALL_OVERRIDES = {
    ...
    ("PMobileConnection", "child"): (
        ...
        "mozilla/dom/mobileconnection/MobileConnectionChild.h",
    ),
    ("PMobileConnection", "parent"): (
        "MobileConnectionParent",
        "mozilla/dom/mobileconnection/MobileConnectionParent.h",
    ),
    ...
    ("PImsRegistration", "child"): (
        ...
        "mozilla/dom/mobileconnection/ImsRegistrationChild.h",
    ),
    ("PImsRegistration", "parent"): (
        "ImsRegistrationParent",
        "mozilla/dom/mobileconnection/ImsRegistrationParent.h",
    ),
    ...
    ("PImsRegServiceFinder", "child"): (
        "ImsRegServiceFinderChild",
        "mozilla/dom/mobileconnection/PImsRegistrationChild.h",
    ),
    ("PIcc", "child"): ("IccChild", "mozilla/dom/icc/IccChild.h"),
    ("PIcc", "parent"): ("IccParent", "mozilla/dom/icc/IccParent.h"),
    ("PIccRequest", "child"): ("IccRequestChild", "mozilla/dom/icc/IccChild.h"),
    ("PIccRequest", "parent"): ("IccRequestParent", "mozilla/dom/icc/IccParent.h"),
    ("PTelephony", "child"): (
        "TelephonyChild",
        "mozilla/dom/telephony/TelephonyChild.h",
    ),
    ("PTelephony", "parent"): (
        "TelephonyParent",
    ...
    ("PSubsidyLock", "parent"): (
        "SubsidyLockParent",
        "mozilla/dom/subsidylock/SubsidyLockParent.h",
    ),
    ...
    ("PSms", "child"): ("SmsChild", "mozilla/dom/mobilemessage/SmsChild.h"),
    ("PSms", "parent"): ("SmsParent", "mozilla/dom/mobilemessage/SmsParent.h"),
    ("PSmsRequest", "child"): (
        "SmsRequestChild",
        "mozilla/dom/mobilemessage/SmsChild.h",
    ),
    ("PSmsRequest", "parent"): (
        "SmsRequestParent",
        "mozilla/dom/mobilemessage/SmsParent.h",
    ),
