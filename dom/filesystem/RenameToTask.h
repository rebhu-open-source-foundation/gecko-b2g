...
class RenameToTaskChild final : public FileSystemTaskChildBase {
 public:
  static already_AddRefed<RenameToTaskChild> Create(FileSystemBase* aFileSystem,
                                                    nsIFile* aDirPath,
                                                    nsIFile* aOldPath,
                                                    const nsAString& aNewName,
                                                    ErrorResult& aRv);

  virtual ~RenameToTaskChild();
 ...
 private:
  RenameToTaskChild(nsIGlobalObject* aGlobalObject, FileSystemBase* aFileSystem,
...
class RenameToTaskParent final : public FileSystemTaskParentBase {
 public:
  static already_AddRefed<RenameToTaskParent> Create(
