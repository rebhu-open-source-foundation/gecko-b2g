...
class DeviceStorageFileSystem : public FileSystemBase {
 public:
  ...
  void Init(nsDOMDeviceStorage* aDeviceStorage);

  // Overrides FileSystemBase

  virtual already_AddRefed<FileSystemBase> Clone() override;

  virtual bool ShouldCreateDirectory() override { return true; }
  ...
  virtual void SerializeDOMPath(nsAString& aSerializedString) const override;
