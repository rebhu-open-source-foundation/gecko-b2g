...
class CreateDirectoryTaskChild final : public FileSystemTaskChildBase {
 public:
  static already_AddRefed<CreateDirectoryTaskChild> Create(
      FileSystemBase* aFileSystem, nsIFile* aTargetPath, ErrorResult& aRv);

  virtual ~CreateDirectoryTaskChild();
 ...
 private:
  CreateDirectoryTaskChild(nsIGlobalObject* aGlobalObject,
...
class CreateDirectoryTaskParent final : public FileSystemTaskParentBase {
 public:
  static already_AddRefed<CreateDirectoryTaskParent> Create(
