...
class FileSystemBase {
 public:
  ...
  static already_AddRefed<FileSystemBase> DeserializeDOMPath(
   ...
   */
  const nsAString& LocalOrDeviceStorageRootPath() const {
  ...
  ePermissionCheckType PermissionCheckType() const {
  ...
  virtual bool NeedToGoToMainThread() const { return false; }

  virtual nsresult MainThreadWork() { return NS_ERROR_FAILURE; }

  virtual bool ClonableToDifferentThreadOrProcess() const { return false; }
