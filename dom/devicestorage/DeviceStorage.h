...
class DeviceStorageFile final : public nsISupports {
 public:
  ...
  DeviceStorageFile(const nsAString& aStorageType,
                    const nsAString& aStorageName, const nsAString& aPath);
  ...
  DeviceStorageFile(const nsAString& aStorageType,
                    const nsAString& aStorageName, const nsAString& aRootDir,
                    const nsAString& aPath);

  void SetPath(const nsAString& aPath);
  void SetEditable(bool aEditable);

  static already_AddRefed<DeviceStorageFile> CreateUnique(
  ...
  nsresult Append(nsIInputStream* aInputStream, nsIOutputStream* aOutputStream);
...
class nsDOMDeviceStorage final : public mozilla::DOMEventTargetHelper,
 ...
 public:
  ...
  already_AddRefed<DOMRequest> AppendNamed(mozilla::dom::Blob* aBlob,
                                           const nsAString& aPath,
                                           ErrorResult& aRv);

  already_AddRefed<DOMRequest> Get(const nsAString& aPath, ErrorResult& aRv) {
    return GetInternal(aPath, false, aRv);
  }
  already_AddRefed<DOMRequest> GetEditable(const nsAString& aPath,
                                           ErrorResult& aRv) {
  ...
  */
  ...
  already_AddRefed<DOMRequest> CreateFileDescriptor(
      const nsAString& aPath, DeviceStorageFileDescriptor* aDSFD,
      ErrorResult& aRv);
  ...
  static void CreateDeviceStorageFor(nsPIDOMWindowInner* aWin,
                                     const nsAString& aType,
                                     nsDOMDeviceStorage** aStore);

  static void CreateDeviceStorageByNameAndType(nsPIDOMWindowInner* aWin,
                                               const nsAString& aName,
                                               const nsAString& aType,
                                               nsDOMDeviceStorage** aStore);

  bool Equals(nsPIDOMWindowInner* aWin, const nsAString& aName,
              const nsAString& aType);
 ...
 private:
  ...
  already_AddRefed<DOMRequest> AddOrAppendNamed(mozilla::dom::Blob* aBlob,
                                                const nsAString& aPath,
                                                bool aCreate, ErrorResult& aRv);

  already_AddRefed<DOMRequest> GetInternal(const nsAString& aPath,
  ...
  */
  ...
  already_AddRefed<nsDOMDeviceStorage> GetStorage(const nsAString& aFullPath,
                                                  nsAString& aOutStoragePath);
  already_AddRefed<nsDOMDeviceStorage> GetStorageByName(
      const nsAString& aStorageName);

  static already_AddRefed<nsDOMDeviceStorage> GetStorageByNameAndType(
      nsPIDOMWindowInner* aWin, const nsAString& aStorageName,
      const nsAString& aType);
