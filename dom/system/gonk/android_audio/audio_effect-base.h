...
enum {
  ...
  EFFECT_FLAG_OUTPUT_MASK =
      49152,  // (((1 << OUTPUT_SIZE) - 1) << OUTPUT_SHIFT)
  ...
  EFFECT_FLAG_HW_ACC_MASK =
      196608,  // (((1 << HW_ACC_SIZE) - 1) << HW_ACC_SHIFT)
  ...
  EFFECT_FLAG_AUDIO_MODE_MASK =
      786432,  // (((1 << AUDIO_MODE_SIZE) - 1) << AUDIO_MODE_SHIFT)
  ...
  EFFECT_FLAG_OFFLOAD_MASK =
      4194304,  // (((1 << OFFLOAD_SIZE) - 1) << OFFLOAD_SHIFT)
  ...
  EFFECT_FLAG_NO_PROCESS_MASK =
      8388608,  // (((1 << NO_PROCESS_SIZE) - 1) << NO_PROCESS_SHIFT)
...
enum {
  ...
  EFFECT_CONFIG_ALL =
      31,  // ((((BUFFER | SMP_RATE) | CHANNELS) | FORMAT) | ACC_MODE)
};
