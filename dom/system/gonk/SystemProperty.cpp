...
static int FakePropertyGet(const char* key, char* value,
...
/*static*/ int Property::Get(const char* key, char* value,
                             const char* default_value) {
...
/*static*/ int Property::Set(const char* key, const char* value) {
  void* libcutils = GetLibcUtils();
  if (libcutils) {
