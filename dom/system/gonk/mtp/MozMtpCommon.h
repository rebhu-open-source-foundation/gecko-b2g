...
#if USE_DEBUG
#  define MTP_DBG(msg, ...)                                                    \
    __android_log_print(ANDROID_LOG_DEBUG, "MozMtp", "%s: " msg, __FUNCTION__, \
                        ##__VA_ARGS__)
#else
#  define MTP_DBG(msg, ...)
#endif
...
#define MTP_LOG(msg, ...)                                                   \
  __android_log_print(ANDROID_LOG_INFO, "MozMtp", "%s: " msg, __FUNCTION__, \
                      ##__VA_ARGS__)

#define MTP_ERR(msg, ...)                                                    \
  __android_log_print(ANDROID_LOG_ERROR, "MozMtp", "%s: " msg, __FUNCTION__, \
                      ##__VA_ARGS__)
...
#define USING_MTP_NAMESPACE using namespace mozilla::system::mtp;

namespace android {
class MOZ_EXPORT MtpServer;
class MOZ_EXPORT MtpStorage;
class MOZ_EXPORT MtpStringBuffer;
class MOZ_EXPORT IMtpDatabase;
