...
class DeletedMessageInfo final : public nsIDeletedMessageInfo {
 public:
  ...
  DeletedMessageInfo(int32_t* aMessageIds, uint32_t aMsgCount,
                     uint64_t* aThreadIds, uint32_t aThreadCount);

  static nsresult Create(int32_t* aMessageIds, uint32_t aMsgCount,
                         uint64_t* aThreadIds, uint32_t aThreadCount,
