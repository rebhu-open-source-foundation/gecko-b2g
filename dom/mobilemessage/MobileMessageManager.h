...
class MobileMessageManager final : public DOMEventTargetHelper,
 ...
 public:
  ...
  void Send(const Sequence<nsString>& aNumbers, const nsAString& aText,
            const SmsSendParameters& aSendParams,
  ...
  already_AddRefed<DOMRequest> Delete(int32_t aId, ErrorResult& aRv);
  ...
  already_AddRefed<Promise> SetSmscAddress(const SmscAddress& aSmscAddress,
 ...
 private:
   ...
   */
  already_AddRefed<DOMRequest> Send(nsISmsService* aSmsService,
                                    uint32_t aServiceId,
                                    const nsAString& aNumber,
                                    const nsAString& aText, ErrorResult& aRv);

  already_AddRefed<DOMRequest> Delete(int32_t* aIdArray, uint32_t aSize,
                                      ErrorResult& aRv);
