...
NS_IMPL_CYCLE_COLLECTION_TRAVERSE_BEGIN_INHERITED(DOMMobileMessageError,
                                                  DOMError)
...
DOMMobileMessageError::DOMMobileMessageError(nsPIDOMWindowInner* aWindow,
                                             ...
                                             SmsMessage* aSms)
    : DOMError(aWindow, aName), mSms(aSms), mMms(nullptr) {}

DOMMobileMessageError::DOMMobileMessageError(nsPIDOMWindowInner* aWindow,
                                             const nsAString& aName,
                                             MmsMessage* aMms)
    : DOMError(aWindow, aName), mSms(nullptr), mMms(aMms) {}

void DOMMobileMessageError::GetData(
    OwningSmsMessageOrMmsMessage& aRetVal) const {
  if (mSms) {
...
JSObject* DOMMobileMessageError::WrapObject(JSContext* aCx,
