...
MobileConnectionRequestChild::Recv__delete__(const MobileConnectionReply& aReply)
{
  ...
  switch (aReply.type()) {
    case MobileConnectionReply::TMobileConnectionReplySuccess:
      return DoReply(aReply.get_MobileConnectionReplySuccess())? IPC_OK(): IPC_FAIL_NO_REASON(this);
    case MobileConnectionReply::TMobileConnectionReplySuccessBoolean:
      return DoReply(aReply.get_MobileConnectionReplySuccessBoolean())? IPC_OK(): IPC_FAIL_NO_REASON(this);
    case MobileConnectionReply::TMobileConnectionReplySuccessNetworks:
      return DoReply(aReply.get_MobileConnectionReplySuccessNetworks())? IPC_OK(): IPC_FAIL_NO_REASON(this);
    case MobileConnectionReply::TMobileConnectionReplySuccessCallForwarding:
      return DoReply(aReply.get_MobileConnectionReplySuccessCallForwarding())? IPC_OK(): IPC_FAIL_NO_REASON(this);
    case MobileConnectionReply::TMobileConnectionReplySuccessCallBarring:
      return DoReply(aReply.get_MobileConnectionReplySuccessCallBarring())? IPC_OK(): IPC_FAIL_NO_REASON(this);
    case MobileConnectionReply::TMobileConnectionReplySuccessCallWaiting:
      return DoReply(aReply.get_MobileConnectionReplySuccessCallWaiting())? IPC_OK(): IPC_FAIL_NO_REASON(this);
    case MobileConnectionReply::TMobileConnectionReplySuccessClirStatus:
      return DoReply(aReply.get_MobileConnectionReplySuccessClirStatus())? IPC_OK(): IPC_FAIL_NO_REASON(this);
    case MobileConnectionReply::TMobileConnectionReplySuccessDeviceIdentities:
      return DoReply(aReply.get_MobileConnectionReplySuccessDeviceIdentities())? IPC_OK(): IPC_FAIL_NO_REASON(this);
    case MobileConnectionReply::TMobileConnectionReplySuccessPreferredNetworkType:
      return DoReply(aReply.get_MobileConnectionReplySuccessPreferredNetworkType())? IPC_OK(): IPC_FAIL_NO_REASON(this);
    case MobileConnectionReply::TMobileConnectionReplySuccessRoamingPreference:
      return DoReply(aReply.get_MobileConnectionReplySuccessRoamingPreference())? IPC_OK(): IPC_FAIL_NO_REASON(this);
    case MobileConnectionReply::TMobileConnectionReplyError:
      return DoReply(aReply.get_MobileConnectionReplyError())? IPC_OK(): IPC_FAIL_NO_REASON(this);
    default:
