...
/* global log, is, ok, startTestCommon, getDataEnabled,
   ...
   TEST_HOST_ROUTE, releaseDataCall, verifyDataCallAttributes, waitForTargetEvent,
   setEmulatorVoiceDataStateAndWait, setRadioEnabledAndWait */
...
function testDataStateConnected(aDataCall) {
  ...
  return Promise.all(promises).then(() =>
    verifyDataCallAttributes(aDataCall, true)
  );
}
