...
class PowerSupplyManager : public DOMEventTargetHelper,
 ...
 private:
  /**
   * Update the power supply status stored in the powersupply manager object
   * using a PowerSupplyStatus object.
   */
  void UpdateFromPowerSupplyStatus(
      const hal::PowerSupplyStatus& aPowerSupplyStatus);
