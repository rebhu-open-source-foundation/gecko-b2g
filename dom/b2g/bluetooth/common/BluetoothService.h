...
class BluetoothService : public nsIObserver,
 ...
 public:
  ...
  virtual void RegisterBluetoothSignalHandler(
      const nsAString& aNodeName, BluetoothSignalObserver* aMsgHandler);
   ...
   * @param aMsgHandler Weak pointer to the object
   */
  void UnregisterAllSignalHandlers(BluetoothSignalObserver* aMsgHandler);
   ...
   */
  void DistributeSignal(const nsAString& aName, const nsAString& aPath);
   ...
   */
  void DistributeSignal(const nsAString& aName,
   ...
   */
  void DistributeSignal(const nsAString& aName, const BluetoothUuid& aUuid);
   ...
   */
  void DistributeSignal(const BluetoothSignal& aSignal);
   ...
   */
  virtual nsresult GetAdaptersInternal(BluetoothReplyRunnable* aRunnable) = 0;
  ...
  virtual nsresult GetConnectedDevicePropertiesInternal(
      uint16_t aServiceUuid, BluetoothReplyRunnable* aRunnable) = 0;
   ...
   * @return NS_OK on success, NS_ERROR_FAILURE otherwise
   */
  virtual nsresult FetchUuidsInternal(const BluetoothAddress& aDeviceAddress,
                                      BluetoothReplyRunnable* aRunnable) = 0;

  /**
   * Stop device discovery (platform specific implementation)
   */
  virtual void StopDiscoveryInternal(BluetoothReplyRunnable* aRunnable) = 0;

  /**
   * Start device discovery (platform specific implementation)
   */
  virtual void StartDiscoveryInternal(BluetoothReplyRunnable* aRunnable) = 0;
  ...
  virtual void StopAdvertisingInternal(const BluetoothUuid& aAppUuid,
                                       BluetoothReplyRunnable* aRunnable) {}
  ...
  virtual nsresult RemoveDeviceInternal(const BluetoothAddress& aDeviceAddress,
                                        BluetoothReplyRunnable* aRunnable) = 0;
   ...
   */
  virtual nsresult GetServiceChannel(const BluetoothAddress& aDeviceAddress,
  ...
  virtual void ConnectSco(BluetoothReplyRunnable* aRunnable) = 0;

  virtual void DisconnectSco(BluetoothReplyRunnable* aRunnable) = 0;

  virtual void IsScoConnected(BluetoothReplyRunnable* aRunnable) = 0;

  virtual void SetObexPassword(const nsAString& aPassword,
                               BluetoothReplyRunnable* aRunnable) = 0;

  virtual void RejectObexAuth(BluetoothReplyRunnable* aRunnable) = 0;

  virtual void ReplyTovCardPulling(BlobImpl* aBlob,
                                   BluetoothReplyRunnable* aRunnable) = 0;

  virtual void ReplyToPhonebookPulling(BlobImpl* aBlob, uint16_t aPhonebookSize,
                                       BluetoothReplyRunnable* aRunnable) = 0;

  virtual void ReplyTovCardListing(BlobImpl* aBlob, uint16_t aPhonebookSize,
                                   BluetoothReplyRunnable* aRunnable) = 0;

  virtual void ReplyToMapFolderListing(uint8_t aMasId,
                                       const nsAString& aFolderlists,
                                       BluetoothReplyRunnable* aRunnable) = 0;

  virtual void ReplyToMapMessagesListing(uint8_t aMasId, BlobImpl* aBlob,
                                         bool aNewMessage,
  ...
  virtual void ReplyToMapSendMessage(uint8_t aMasId, const nsAString& aHandleId,
                                     bool aStatus,
                                     BluetoothReplyRunnable* aRunnable) = 0;

  virtual void ReplyToMapMessageUpdate(uint8_t aMasId, bool aStatus,
                                       BluetoothReplyRunnable* aRunnable) = 0;

#ifdef MOZ_B2G_RIL
  virtual void AnswerWaitingCall(BluetoothReplyRunnable* aRunnable) = 0;

  virtual void IgnoreWaitingCall(BluetoothReplyRunnable* aRunnable) = 0;

  virtual void ToggleCalls(BluetoothReplyRunnable* aRunnable) = 0;
#endif
   ...
   */
  virtual void ConnectGattClientInternal(const BluetoothUuid& aAppUuid,
  ...
  virtual void UnregisterGattClientInternal(
      int aClientIf, BluetoothReplyRunnable* aRunnable) = 0;
  ...
  nsresult EnableDisable(bool aEnable, BluetoothReplyRunnable* aRunnable);
   ...
   */
  virtual nsresult StartInternal(BluetoothReplyRunnable* aRunnable) = 0;
   ...
   * @return NS_OK on correct startup, NS_ERROR_FAILURE otherwise
   */
  virtual nsresult StopInternal(BluetoothReplyRunnable* aRunnable) = 0;
 ...
 protected:
  ...
  nsresult StartBluetooth(bool aIsStartup, BluetoothReplyRunnable* aRunnable);

  nsresult StopBluetooth(bool aIsStartup, BluetoothReplyRunnable* aRunnable);

  nsresult StartStopBluetooth(bool aStart, bool aIsStartup,
                              BluetoothReplyRunnable* aRunnable);

  /**
   * Called when XPCOM first creates this service.
   */
  virtual nsresult HandleStartup();

  virtual void CompleteToggleBt(bool aEnabled);
   ...
   */
  virtual nsresult HandleShutdown();
