...
static status_t ConvertParamSetsToDescriptorBlob(
    sp<ABuffer>& aSPS, sp<ABuffer>& aPPS, nsTArray<uint8_t>* aOutputBuf) {
...
static int NALType(sp<ABuffer>& aBuffer) {
  if (aBuffer == nullptr) {
