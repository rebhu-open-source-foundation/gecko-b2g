...
StkDuration.prototype = {
  QueryInterface: ChromeUtils.generateQI([Ci.nsIStkDuration]),
...
StkIcon.prototype = {
  QueryInterface: ChromeUtils.generateQI([Ci.nsIStkIcon]),
...
StkIconInfo.prototype = {
  QueryInterface: ChromeUtils.generateQI([Ci.nsIStkIconInfo]),
...
StkItem.prototype = {
  QueryInterface: ChromeUtils.generateQI([Ci.nsIStkItem]),
...
StkTimer.prototype = {
  QueryInterface: ChromeUtils.generateQI([Ci.nsIStkTimer]),
...
StkLocationInfo.prototype = {
  QueryInterface: ChromeUtils.generateQI([Ci.nsIStkLocationInfo]),
...
StkProactiveCommand.prototype = {
  QueryInterface: ChromeUtils.generateQI([Ci.nsIStkProactiveCmd]),
...
StkTerminalResponse.prototype = {
  QueryInterface: ChromeUtils.generateQI([Ci.nsIStkTerminalResponse]),
