...
const MARIONETTE_TIMEOUT = 20000;
const MARIONETTE_HEAD_JS = "head.js";

/* global verifyWithPeekedStkEnvelope, startTestCommon, getMozIcc */
...
startTestCommon(function() {
  ...
  return Promise.resolve()
    .then(() =>
      icc.sendStkTimerExpiration({ timerId: 5, timerValue: 1234567 / 1000 })
    )
    .then(() =>
