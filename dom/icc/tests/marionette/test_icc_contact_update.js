...
const MARIONETTE_TIMEOUT = 120000;
...
function testUpdateContact(
  ...
  log(
    "testUpdateContact: type=" +
      aType +
      ", mozContact=" +
      JSON.stringify(aMozContact) +
      ", expect=" +
      aExpect.number +
      ", pin2=" +
      aPin2
  ...
  return aIcc.updateContact(aType, contact, aPin2).then(
    aResult => {
