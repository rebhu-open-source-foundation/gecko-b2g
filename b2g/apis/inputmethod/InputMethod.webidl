...
interface MozInputMethod : EventTarget {
   ...
   */
  // FIXME(fabrice): Unknown extended attribute CheckAnyPermissions on attribute
   ...
   */
  // FIXME(fabrice): Unknown extended attribute CheckAnyPermissions on method
  // [CheckAnyPermissions="input"]
...
interface MozInputContextFocusEventDetail {
   ...
   */
  // FIXME(fabrice): error: An attribute cannot be of a dictionary type
  // [Pure, Cached, Frozen]
