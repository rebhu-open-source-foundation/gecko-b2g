...
function run_test() {
  ...
  do_check_eq(
    TelURIParser.parseURI("tel", "tel:+-.()1234567890"),
    "+-.()1234567890"
  );
  ...
  do_check_eq(
    TelURIParser.parseURI("tel", "tel:-.()1234567890ABCDpw"),
    "-.()1234567890ABCDpw"
  );
  ...
  do_check_eq(
    TelURIParser.parseURI("tel", "tel:123;phone-context=+0321"),
    "+0321123"
  );

  // local-phone-number => isdn-subaddress + post-dial + prefix
  do_check_eq(
    TelURIParser.parseURI(
      "tel",
      "tel:123;isub=123;postd=123;phone-context=+0321"
    ),
    "+0321123"
  );
}
